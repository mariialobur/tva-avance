...
const EXAM_BLUEPRINT=[
  ...
  {label:'Impôt préalable & immobilier',count:3,ids:['option','ip405','ip415','ip410','proof','immovable20']},
  {label:'Structures & opérations particulières',count:3,ids:['sub900','sub420','group','tdfnToEff','effToTdfn','related-value','netting']},
  {label:'Contrôle, rectification & clôture',count:3,ids:['concordance','isolatedCorrection','annualDifference','controlTurnover','documents','annual-differences','control-docs']}
];
